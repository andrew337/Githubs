...
class FollowerListVC: UIViewController {
            ...
            case .success(let user):
                ...
                PersistanceManager.updateWith(favorite: favorite, actionType: .add) { [weak self] error in
                    ...
                    guard let error = error else {
                        self.presentGFAlertOnMainThread(title: "Success!", message: "You have successfully favorited this user", button: "Okay")
                        return
                    }
                    self.presentGFAlertOnMainThread(title: "Something went wrong", message: error.rawValue, button: "Okay")
                }
    ...
    func getFollowers (username : String, page : Int) {
        ...
        NetworkManager.shared.getFollowers(for: username, page: page) { [weak self] result in
            ...
            case .failure(let error):
                self.presentGFAlertOnMainThread(title: "Test", message: error.rawValue, button: "ok")
            }
